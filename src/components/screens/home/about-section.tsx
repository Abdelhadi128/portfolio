...
export default function AboutSection () {
    ...
    return (
        <div id='about' className='w-full min-h-screen md:h-screen flex flex-col items-center py-20'>
            <div className='md:container flex flex-col h-full'>
                ...
                <div className='flex-1 w-full flex flex-col justify-center items-center md:m-0 sm:p-5 md:p-0'>
                    <div className='md:w-9/12 md:font-fira md:text-lg text-justify flex flex-col text-[#e4e4e7] bg-[#141517] border border-[#27292c] p-2 md:p-5 rounded-xl'>
                    ...
                    <div className='md:w-9/12 flex flex-col sm:grid sm:grid-cols-2 md:grid md:grid-cols-3 gap-4 mt-6 md:mt-3 mx-1' >
                        {
                            skils.map((skil)=>(
                                <div className='w-full h-full group p-5 bg-[#141517] rounded-xl border border-[#0a824b] md:border-[#27292c] hover:border-[#008f00]'>
                                    <div>
                                        {skil.icon}
                                    </div>
                                    ...
                                    <P className='text-[#7f8489] text-justify'>
                                        {skil.description}
                                    </P>
                                </div>
                            ))
